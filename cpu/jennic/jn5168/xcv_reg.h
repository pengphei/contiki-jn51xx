 ...
 * MODULE:             MAC
 *
 * COMPONENT:          $HeadURL: https://www.collabnet.nxp.com/svn/lprf_sware/Projects/Components/Xcv/Tags/JN516x_SDK_Generic_R_Gate_RC1a/Include/xcv_reg.h $
 *
 * REVISION:           $Revision: 43543 $
 *
 * DATED:              $Date: 2012-06-19 18:13:49 +0100 (Tue, 19 Jun 2012) $
 *
 * STATUS:             $Id: xcv_reg.h 43543 2012-06-19 17:13:49Z nxp29736 $
 *
 * AUTHOR:             rcc
 *
 * DESCRIPTION:
 ...
 *
 * LAST MODIFIED BY:   $Author: nxp29736 $
 *
 *
 ****************************************************************************
 *
...
#define XCV_REG_RXCTL_SEC_BIT   6
#define XCV_REG_RXCTL_SEC_MASK  ((uint32)(BIT_W_1 << XCV_REG_RXCTL_SEC_BIT))
#endif

#ifdef CHIP_RELEASE_2
#define XCV_REG_RXCTL_FORMAT(sched_basis, sched_ss, in_cap, auto_ack) \
   (XCV_REG_RXCTL_SEC_MASK | \
    ((sched_basis) & BIT_W_1) | \
...
#ifdef CHIP_RELEASE_2
#define XCV_REG_TXCTL_SEC_BIT   6
#define XCV_REG_TXCTL_SEC_MASK  ((uint32)(BIT_W_1 << XCV_REG_TXCTL_SEC_BIT))
#endif

#ifdef CHIP_RELEASE_1
/* Used to be XCV_REG_TXCTL_FORMAT, changed because parameters different. Note
   that slot_override is not used with CHIP_RELEASE_1 */
...
#define XCV_REG_TXMBEBT_MINBE_MASK ((uint32)(BIT_W_2 << XCV_REG_TXMBEBT_MINBE_BIT))
#define XCV_REG_TXMBEBT_MAXBO_BIT 3
#define XCV_REG_TXMBEBT_MAXBO_MASK ((uint32)(BIT_W_3 << XCV_REG_TXMBEBT_MAXBO_BIT))
#define XCV_REG_TXMBEBT_BLE_BIT   2
...
#ifdef CC_BUILD
#ifdef HDK_BUILD
/* CC SPI master replaces PHY controller */
#define XCV_SPICC_OFFSET 0x380
#else
/* CC SPI master is at 0xa8000000 so offset is (0xa8000000 - XCV_BASE_ADDR) / 4 */
#define XCV_SPICC_OFFSET 0x26000000
#endif
#endif
...
typedef enum
{
    ...
    XCV_REG_ISA_STE   = XCV_SEC_OFFSET + 4, /* ACL suite */
#endif
#ifndef CHIP_RELEASE_1
...
#ifdef CHIP_RELEASE_2
    XCV_REG_ISA_CHK0  = XCV_SEC_OFFSET + 12,
    XCV_REG_ISA_CHK1  = XCV_SEC_OFFSET + 13,
    XCV_REG_ISA_CHK2  = XCV_SEC_OFFSET + 14,
    XCV_REG_ISA_CHK3  = XCV_SEC_OFFSET + 15,
#endif
#endif
#endif
...
#ifdef CHIP_RELEASE_1
    XCV_REG_AES_ACL_CMD       = XCV_AES_OFFSET + 9,
    XCV_REG_AES_BCMODE        = XCV_AES_OFFSET + 41,
    XCV_REG_AES_CTR           = XCV_AES_OFFSET + 19,
    XCV_REG_AES_DATA_IN       = XCV_AES_OFFSET + 4,
    XCV_REG_AES_DATA_OUT      = XCV_AES_OFFSET + 11,
    XCV_REG_AES_RI_CCM_ML     = XCV_AES_OFFSET + 23,
    XCV_REG_AES_RI_CCM_NONCE  = XCV_AES_OFFSET + 24,
    XCV_REG_AES_RI_CCM_ALEN_0 = XCV_AES_OFFSET + 32,
    XCV_REG_AES_RI_CCM_ALEN_1 = XCV_AES_OFFSET + 33,
    XCV_REG_AES_RI_CCM_MLEN_0 = XCV_AES_OFFSET + 34,
    XCV_REG_AES_RI_CCM_MLEN_1 = XCV_AES_OFFSET + 35,
    XCV_REG_AES_CCM_AUTH      = XCV_AES_OFFSET + 28,
    XCV_REG_AES_STATUS        = XCV_AES_OFFSET + 40,
    XCV_REG_AES_CCM_CHK_0     = XCV_AES_OFFSET + 36,
    XCV_REG_AES_CCM_CHK_1     = XCV_AES_OFFSET + 37,
    XCV_REG_AES_CCM_CHK_2     = XCV_AES_OFFSET + 38,
    XCV_REG_AES_CCM_CHK_3     = XCV_AES_OFFSET + 39,
    XCV_REG_AES_IV            = XCV_AES_OFFSET + 15,
    XCV_REG_AES_INT           = XCV_AES_OFFSET + 8,
    XCV_REG_AES_INT_EN        = XCV_AES_OFFSET + 10,
#else
...
#ifdef CC_BUILD
    /* SPI master (CC build) */
    XCV_REG_SPICC_BUF  = XCV_SPICC_OFFSET,
    XCV_REG_SPICC_CTRL = XCV_SPICC_OFFSET + 1,
    XCV_REG_SPICC_DIV  = XCV_SPICC_OFFSET + 2,
    XCV_REG_SPICC_SS   = XCV_SPICC_OFFSET + 3,
    XCV_REG_SPICC_IE   = XCV_SPICC_OFFSET + 4,
    XCV_REG_SPICC_IS   = XCV_SPICC_OFFSET + 5,
    XCV_REG_SPICC_RESET= XCV_SPICC_OFFSET + 6,
#endif
#endif /* NEC_78K */
